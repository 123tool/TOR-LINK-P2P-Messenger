...
​Dapatkan Alamat:
Aplikasi akan menampilkan alamat unik Anda (contoh: v2c3...xyz.onion).
​Kirim Pesan:
...
### ​📝 Catatan untuk Developer (Sisi "Premium")
​Enkripsi: Untuk versi lebih "Pro", Anda bisa menambahkan library cryptography (RSA) agar pesan dienkripsi sebelum masuk ke jaringan Tor.
​UI: Karena ini CLI, saya buatkan sebersih mungkin agar nyaman dilihat di Termux.
